...
let AuditLogController = class AuditLogController {
    ...
    async findAll(query) {
        ...
        return this.auditLogService.findAll(page, limit, query.userId, query.action, from, to);
    }
    async findByUserId(userId, query) {
        return this.auditLogService.findByUserId(userId, query.page ?? 1, query.limit ?? 20);
    }
